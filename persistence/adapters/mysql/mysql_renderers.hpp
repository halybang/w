#pragma once
#ifndef PERSISTENCE_ADAPTERS_MYSQL_RENDERERS_HPP_INCLUDED
#define PERSISTENCE_ADAPTERS_MYSQL_RENDERERS_HPP_INCLUDED
...
namespace persistence {
  ...
  struct MySQLQueryRenderer : ast::ISQLQueryRenderer {
    IConnection& conn;
    const IResolveSymbolicRelation& symbolic_relation_resolver;
    MySQLQueryRenderer(IConnection& conn, const IResolveSymbolicRelation& rel) : conn(conn), symbolic_relation_resolver(rel) {}
  ...
  struct MySQLValueRenderer : ast::ISQLValueRenderer {
    IConnection& conn;
    const IResolveSymbolicRelation& symbolic_relation_resolver;
    MySQLValueRenderer(IConnection& conn, const IResolveSymbolicRelation& rel) : conn(conn), symbolic_relation_resolver(rel) {}
...
#endif // PERSISTENCE_ADAPTERS_MYSQL_RENDERERS_HPP_INCLUDED
